...
независимости (формула [1](#orglatexenvironment1)).
...
Программа состоит из двух модулей: главного ([`main.rs`](./src/main.rs))
...
[3](#orgsrcblock1)). Производится ввод двух целых чисел через
...
классу (листинги [5](#orgsrcblock3), [6](#orgsrcblock4)). Нежелательно,
...
(листинги [7](#orgsrcblock5), [8](#orgsrcblock6)).
...
непрерывной интеграции (Continuous Integration) (листинг [10](#orgsrcblock8)).
...
[11](#orgsrcblock9)). Каждая из полей структуры представляет из себя матрицу
(таблица [1](#orgtable1)).
...
<caption class="t-above"><span class="table-number">&#1058;&#1072;&#1073;&#1083;&#1080;&#1094;&#1072; 1.:</span> Внутреннее представление структуры `Gaussian`</caption>
...
<th scope="col" class="org-left">\(feature_{1}\)</th>
<th scope="col" class="org-left">\(feature_{2}\)</th>
<th scope="col" class="org-left">\(feature_{3}\)</th>
<th scope="col" class="org-left">&#x2026;</th>
<th scope="col" class="org-left">\(feature_{n}\)</th>
</tr>
</thead>

<tbody>
<tr>
<td class="org-left">\(Class_{1}\)</td>
<td class="org-left">exp, var</td>
<td class="org-left">exp, var</td>
<td class="org-left">exp, var</td>
...
Статический метод `from_model` (листинг [12](#orgsrcblock10)) на вход принимает
...
Метод `compute_gaussian` (листинг [13](#orgsrcblock11)) на вход принимает
...
[14](#orgsrcblock12)) на вход принимает матрицу объектов
...
(листинг [15](#orgsrcblock13)) и запишем в файл (`variant.inp`).
